...
function stopwatch() //main stopwatch function
{
	sseconds++;
	if(sseconds == 100)
	{
	...
	function frontZero(x, y) //to put the zeroes in front if its a single digit
	{
		if(x < 10)
		{
			y = "0" + x.toString();
...
function clickReset() //when the reset button is clicked
{
	sseconds = 0;
	seconds = 0;
	hours = 0;
